  ...
  <div class="right">
    ...
    <div class="bb-doc-demo-block">
      ...
      <div class="demo-button-row">
        <bb-cellGroup>
          <bb-cell title="单元格" value='内容' />
          <bb-cell title="单元格" value='内容' label="描述信息" />
        </bb-cellGroup>
      </div>
    </div>
    <!-- 只设置value -->
    <div class="bb-doc-demo-block">
      <h2 class="bb-doc-demo-block__title">只设置 value</h2>
      <div class="demo-button-row">
        <bb-cell value='内容' />
      </div>
    </div>
    <!-- 垂直居中 -->
    <div class="bb-doc-demo-block">
      <h2 class="bb-doc-demo-block__title">垂直居中</h2>
      <div class="demo-button-row">
